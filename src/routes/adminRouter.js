...
router.get('/register', protectedRoute, (req, res, next) => controller.registerUser(req, res, next))
router.post('/register', protectedRoute, (req, res, next) => controller.registerPage(req, res, next))
